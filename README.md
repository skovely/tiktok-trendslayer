...
| 功能 | 说明 |
|----------------|---------|
| 📊 **实时监控** | 实时监测 GMV 增长斜率。当某个商品在 24 小时内销量增速翻倍，且挂车达人数仍处于低位时，系统将自动触发“蓝海预警” |
| 🔥 **爆款识别** | 筛选 GMV 增速前 5% 商品 + 24h 销量翻倍的黑马 SKU |
| 🤖 **AI 分析** | AI 自动解析高转化视频的“黄金 3 秒”Hook、脚本结构与 BGM 情绪，为您提供 1:1 可复刻的爆款脚本公式。 |
| 👥 **达人匹配** | 自动匹配互动率 > 5% 的中小达人（10K-100K 粉丝），基于商品画像自动筛选最具带货潜力的 KOC，拒绝只看粉丝数，只看实战转化率 |
| 📝 **选品报告** | 支持导出包含商品图、当前销量、预估利润、竞争程度及推荐话术的完整报告 |
