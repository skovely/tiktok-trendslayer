...
💡 编写策略： 给出具体的场景，让用户直接复制就能看到效果。
- 全局搜索：@TikTok-Trend-Slayer 帮我找出过去 48 小时内在美国区 3C 类目下增长最快的 3 个黑马商品。
- 深度拆解：针对这款 [商品名]，分析其最近 5 个爆火视频的脚本结构，并给我 3 个适合拍摄的 Hook。
- 达人匹配：我想推一款磁吸充电宝，请列出 5 位近期带过同类产品且互动率超过 5% 的中小达人。
